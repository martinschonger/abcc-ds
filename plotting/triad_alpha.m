function h = triad_alpha(varargin)
...
kids(1) = plot3([0,1],[0,0],[0,0],'Color',[1,0,0,0.6],'Tag','X-Axis','Parent',h);
kids(2) = plot3([0,0],[0,1],[0,0],'Color',[0,1,0,0.6],'Tag','Y-Axis','Parent',h);
kids(3) = plot3([0,0],[0,0],[0,1],'Color',[0,0,1,0.6],'Tag','Z-Axis','Parent',h);
